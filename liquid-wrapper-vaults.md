...
(Using one of our partners, SolidLizard(https://solidlizard.finance/) $SLIZ as an example)
They have a 2.5X Boost function for their LP farms. If a user stakes $SLIZ as a veNFT, locking it for a period of time, they will receive Boosts on the LP farms they stake in.
The larger the veNFT they have, the more they will be able to Boost the LP farms. https://solidlizard.gitbook.io/solidlizard/how-to-use-the-boost-calculator
...
- *Note: Withdrawals are subject to available $SLIZ in the Vault Reserves. Reserves are constanly topped up from above-mentioned sources (bribes/Boost Rewards etc.). Vault Strategy is based on our Liquidizer Vault (one of our other unique strategies, more info here)
